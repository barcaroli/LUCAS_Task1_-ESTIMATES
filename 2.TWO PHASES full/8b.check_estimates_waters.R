#######################################################################
# LUCAS - Check of estimates variations for Land Cover G and H
#######################################################################
library(xlsx)
# setwd("C:\\Users\\Giulio\\Google Drive\\LUCAS 2025\\Task 1 - ESTIMATES\\2.TWO PHASES full\\anomalies")
setwd("D:/Google Drive/LUCAS 2025/Task 1 - ESTIMATES/2.TWO PHASES full/anomalies")
...
for (w in (1:length(variable))) {
  ...
  anom$signal
  cat("\n *** Variable: ",variable[w],"\n")
  # w <- which(variable == "SURVEY_LC1_2G2")
