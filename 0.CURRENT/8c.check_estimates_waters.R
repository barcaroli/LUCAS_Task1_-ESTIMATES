#######################################################################
# LUCAS - Check of estimates variations for waters and wetland
#######################################################################
library(xlsx)
setwd("C:/Users/Giulio/Google Drive/LUCAS/task 4/estimates_hrl_clc/anomalies")
filename = "waters_anomalies.xlsx"
unlink(filename)

variable = c("SURVEY_LC1_1G","SURVEY_LC1_1H",
    ...
    if (ncol(df) == 21) {
      if (nrow(df[df$Variable==variable[w],]) > 0) {
        if (!is.na(df[df$Variable==variable[w],c("Area_2018")]) & !is.na(df[df$Variable==variable[w],c("Area_2015")]) ) {
          if (df[df$Variable==variable[w],c("Area_2018")] > df[df$Variable==variable[w],c("Area_2015")]*1.1  
              | df[df$Variable==variable[w],c("Area_2018")] < df[df$Variable==variable[w],c("Area_2015")]*0.9) {
            k = k+ 1
            sw2018 <- 1
            sw2015 <- 1
            ...
            anom$signal[k] <- "Area 2018 exceeding Area 2015 +/- 10%"
            ...
            if (df[df$Variable==variable[w],c("Area_2015")] < df[df$Variable==variable[w],c("CI_lower.3")]) anom$signal[k] <- "Area 2015 external to 2018 C.I."
            ...
            if (df[df$Variable==variable[w],c("CI_upper.2")] < df[df$Variable==variable[w],c("CI_lower.3")]) anom$signal[k] <- "C.I. 2015 non overlapping C.I. 2018"
          }
        }
        if (!is.na(df[df$Variable==variable[w],c("Area_2015")]) & !is.na(df[df$Variable==variable[w],c("Area_2012")]) ) {
          if (df[df$Variable==variable[w],c("Area_2015")] > df[df$Variable==variable[w],c("Area_2012")]*1.1  
              | df[df$Variable==variable[w],c("Area_2015")] < df[df$Variable==variable[w],c("Area_2012")]*0.9) {
            k = k+ 1
            sw2015 <- 1
            anom$country[k] <- countries[i]
            anom$Variable[k] <- variable[w]
            ...
            # anom$Area2015_SE[k] <- df[df$Variable==variable[w],c("Std_error.2")],2)
            # anom$Area2015_CV[k] <- df[df$Variable==variable[w],c("CV.2")],3)
            anom$signal[k] <- "Area 2015 exceeding Area 2012 +/- 10%"
            ...
            if (df[df$Variable==variable[w],c("Area_2012")] < df[df$Variable==variable[w],c("CI_lower.2")]) anom$signal[k] <- "Area 2012 external to 2015 C.I."
            ...
            if (df[df$Variable==variable[w],c("CI_upper.1")] < df[df$Variable==variable[w],c("CI_lower.2")]) anom$signal[k] <- "C.I. 2012 non overlapping C.I. 2015"
            anom$Area2018[k] <- df[df$Variable==variable[w],c("Area_2018")]
            anom$Area2018_CI_l[k] <- df[df$Variable==variable[w],c("CI_lower.3")]
            anom$Area2018_CI_u[k] <- df[df$Variable==variable[w],c("CI_upper.3")]
        ...
        if (!is.na(df[df$Variable==variable[w],c("Area_2012")]) & !is.na(df[df$Variable==variable[w],c("Area_2009")]) ) {
          if (df[df$Variable==variable[w],c("Area_2012")] > df[df$Variable==variable[w],c("Area_2009")]*1.1  
              | df[df$Variable==variable[w],c("Area_2012")] < df[df$Variable==variable[w],c("Area_2009")]*0.9) {
            k = k+ 1
            sw2012 <- 1
            anom$country[k] <- countries[i]
            anom$Variable[k] <- variable[w]
            ...
            # anom$Area2012_SE[k] <- df[df$Variable==variable[w],c("Std_error.1")],2)
            # anom$Area2012_CV[k] <- df[df$Variable==variable[w],c("CV.1")],3)
            anom$signal[k] <- "Area 2012 exceeding Area 2009 +/- 10%"
            ...
            if (df[df$Variable==variable[w],c("Area_2009")] < df[df$Variable==variable[w],c("CI_lower.1")]) anom$signal[k] <- "Area 2009 external to 2012 C.I."
            ...
            if (df[df$Variable==variable[w],c("CI_upper")] < df[df$Variable==variable[w],c("CI_lower.1")]) anom$signal[k] <- "C.I. 2009 non overlapping C.I. 2012"
            anom$Area2015[k] <- df[df$Variable==variable[w],c("Area_2015")]
            anom$Area2015_CI_l[k] <- df[df$Variable==variable[w],c("CI_lower.2")]
            anom$Area2015_CI_u[k] <- df[df$Variable==variable[w],c("CI_upper.2")]
      ...
      if (nrow(df[df$Variable==variable[w],]) > 0) {
        if (!is.na(df[df$Variable==variable[w],c("Area_2018")]) & !is.na(df[df$Variable==variable[w],c("Area_2015")]) ) {
          if (df[df$Variable==variable[w],c("Area_2018")] > df[df$Variable==variable[w],c("Area_2015")]*1.1  
            ...
            if (df[df$Variable==variable[w],c("Area_2015")] < df[df$Variable==variable[w],c("CI_lower.2")]) anom$signal[k] <- "Area 2015 external to 2018 C.I."
            ...
            if (df[df$Variable==variable[w],c("CI_upper.1")] < df[df$Variable==variable[w],c("CI_lower.2")]) anom$signal[k] <- "C.I. 2015 non overlapping C.I. 2018"
          }
        }
        if (!is.na(df[df$Variable==variable[w],c("Area_2015")]) & !is.na(df[df$Variable==variable[w],c("Area_2012")]) ) {
          if (df[df$Variable==variable[w],c("Area_2015")] > df[df$Variable==variable[w],c("Area_2012")]*1.1  
            ...
            if (df[df$Variable==variable[w],c("Area_2012")] < df[df$Variable==variable[w],c("CI_lower.1")]) anom$signal[k] <- "Area 2012 external to 2015 C.I."
            ...
            if (df[df$Variable==variable[w],c("CI_upper")] < df[df$Variable==variable[w],c("CI_lower.1")]) anom$signal[k] <- "C.I. 2012 non overlapping C.I. 2015"
          }
        }
      }
    }
      ...
      if (nrow(df[df$Variable==variable[w],]) > 0) {
        if (!is.na(df[df$Variable==variable[w],c("Area_2018")]) & !is.na(df[df$Variable==variable[w],c("Area_2015")]) ) {
          if (df[df$Variable==variable[w],c("Area_2018")] > df[df$Variable==variable[w],c("Area_2015")]*1.1  
            ...
            if (df[df$Variable==variable[w],c("Area_2015")] < df[df$Variable==variable[w],c("CI_lower.1")]) anom$signal[k] <- "Area 2015 external to 2018 C.I."
            ...
            if (df[df$Variable==variable[w],c("CI_upper")] < df[df$Variable==variable[w],c("CI_lower.1")]) anom$signal[k] <- "C.I. 2015 non overlapping C.I. 2018"
          }
        }
      }
    }
