...
# read countries:
# load("C:/Users/UTENTE/Desktop/Progetto_LUCAS/Task1/2.TWO PHASES full//Script/countries.RData")
load("D:/Google Drive/LUCAS 2025/Task 1 - ESTIMATES/2.TWO PHASES full/Script/countries.RData")
...
for(i in 1:length(countries)){
  ...
  c1=c1 %>% 
    pivot_longer(cols=starts_with(countries[i]), names_to = "NUTS1", values_to = "value")  %>%
  pivot_wider(names_from = variable, values_from = value)
  #seleziono solo le variabili di interesse
  c1<-  c1 %>% select(NUTS1, contains("Total.SURVEY_LC1_2"), contains("Total.SURVEY_LC1_3"), contains("Total.SURVEY_LU1_2"), contains("Total.SURVEY_LU1_3"))
...
c1=c1 %>% 
    pivot_longer(cols=-NUTS1, names_to = "Variable", values_to = "value")
...
c1= c1 %>% pivot_wider(names_from = "tipo", values_from = "value")
  ...
  #-------------------
  # setwd("C:/Users/UTENTE/Desktop/Progetto_LUCAS/Task1/2.TWO PHASES full/estimates2022")
  setwd("D:/Google Drive/LUCAS 2025/Task 1 - ESTIMATES/2.TWO PHASES full/estimates2022")
  # leggo i dati delle stime europee nelle due procedure:
  ...
  c2=c2 %>% 
    ...
    pivot_wider(names_from = variable, values_from = value)
  #seleziono solo le variabili di interesse
  c2<-  c2 %>% select(NUTS1, contains("Total.SURVEY_LC1_2"), contains("Total.SURVEY_LC1_3"), contains("Total.SURVEY_LU1_2"), contains("Total.SURVEY_LU1_3"))
