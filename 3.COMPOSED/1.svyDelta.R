...
# # calibration
# poptot2018 <- pop.template(data=des_2018, 
#                            calmodel= ~ NUTS0_16 - 1, partition= FALSE)
...
#                          df.population= poptot2022, 
#                          calmodel= ~ NUTS0_16 - 1, 
#                          calfun= "linear") 
# check.cal(cal_2022)
# s2022$wgt_cal <- weights(cal_2022)
# sum(s2022$wgt_cal)
# save.image(file="svyDelta.RData")
load("svyDelta.RData")
#-------------------------------
...
artificial_NUTS0 <- svyDelta(expr=expression((LC2022A.2 - LC2018A.1)/LC2018A.1),
         ...
         conf.int = TRUE, conf.lev = 0.95)
artificial_NUTS0
write.xlsx(artificial,"svyDelta_results.xlsx",append=FALSE,sheetName = "art")
write.xlsx(artificial_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "artNUTS0")
#------------------------------------------------------------------------------
...
cropland_NUTS0 <- svyDelta(expr=expression((LC2022B.2 - LC2018B.1)/LC2018B.1),
                             ...
                             conf.int = TRUE, conf.lev = 0.95)
cropland_NUTS0
write.xlsx(cropland,"svyDelta_results.xlsx",append=TRUE,sheetName = "crop")
write.xlsx(cropland_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "cropNUTS2")
#------------------------------------------------------------------------------
...
woodland_NUTS0 <- svyDelta(expr=expression((LC2022C.2 - LC2018C.1)/LC2018C.1),
                           ...
                           conf.int = TRUE, conf.lev = 0.95)
woodland_NUTS0
write.xlsx(woodland,"svyDelta_results.xlsx",append=TRUE,sheetName = "wood")
write.xlsx(woodland_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "woodNUTS2")
#------------------------------------------------------------------------------
...
shrubland_NUTS0 <- svyDelta(expr=expression((LC2022D.2 - LC2018D.1)/LC2018D.1),
                           ...
                           conf.int = TRUE, conf.lev = 0.95)
shrubland_NUTS0
write.xlsx(shrubland,"svyDelta_results.xlsx",append=TRUE,sheetName = "shrub")
write.xlsx(shrubland_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "shrubNUTS2")
#------------------------------------------------------------------------------
...
grassland_NUTS0 <- svyDelta(expr=expression((LC2022E.2 - LC2018E.1)/LC2018E.1),
                            ...
                            conf.int = TRUE, conf.lev = 0.95)
grassland_NUTS0
write.xlsx(grassland,"svyDelta_results.xlsx",append=TRUE,sheetName = "grass")
write.xlsx(grassland_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "grassNUTS2")
#------------------------------------------------------------------------------
...
bareland_NUTS0 <- svyDelta(expr=expression((LC2022F.2 - LC2018F.1)/LC2018F.1),
                            ...
                            conf.int = TRUE, conf.lev = 0.95)
bareland_NUTS0
write.xlsx(bareland,"svyDelta_results.xlsx",append=TRUE,sheetName = "bare")
write.xlsx(bareland_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "bareNUTS2")
#
#------------------------------------------------------------------------------
...
water_NUTS0 <- svyDelta(expr=expression((LC2022G.2 - LC2018G.1)/LC2018G.1),
                           ...
                           conf.int = TRUE, conf.lev = 0.95)
water_NUTS0
write.xlsx(water,"svyDelta_results.xlsx",append=TRUE,sheetName = "water")
write.xlsx(water_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "waterNUTS2")
#
#------------------------------------------------------------------------------
...
#                         conf.int = TRUE, conf.lev = 0.95)
# wetland_NUTS0
write.xlsx(wetland,"svyDelta_results.xlsx",append=TRUE,sheetName = "wetland")
# write.xlsx(wetland_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "wetlandNUTS2")
...
primary_NUTS0 <- svyDelta(expr=expression((LU2022U1.2 - LU2018U1.1)/LU2018U1.1),
                          ...
                          conf.int = TRUE, conf.lev = 0.95)
primary_NUTS0
write.xlsx(primary,"svyDelta_results.xlsx",append=TRUE,sheetName = "primary")
write.xlsx(primary_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "primaryNUTS2")
...
#                           conf.int = TRUE, conf.lev = 0.95)
# secondary_NUTS0
write.xlsx(secondary,"svyDelta_results.xlsx",append=TRUE,sheetName = "secondary")
# write.xlsx(secondary_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "secondaryNUTS2")
...
tertiary_NUTS0 <- svyDelta(expr=expression((LU2022U3.2 - LU2018U3.1)/LU2018U3.1), 
                            ...
                            conf.int = TRUE, conf.lev = 0.95)
tertiary_NUTS0
write.xlsx(tertiary,"svyDelta_results.xlsx",append=TRUE,sheetName = "tertiary")
write.xlsx(tertiary_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "tertiaryNUTS2")
...
unused_NUTS0 <- svyDelta(expr=expression((LU2022U4.2 - LU2018U4.1)/LU2018U4.1), 
                           ...
                           conf.int = TRUE, conf.lev = 0.95)
unused_NUTS0
write.xlsx(unused,"svyDelta_results.xlsx",append=TRUE,sheetName = "unused")
write.xlsx(unused_NUTS0,"svyDelta_results.xlsx",append=TRUE,sheetName = "unusedNUTS2")
