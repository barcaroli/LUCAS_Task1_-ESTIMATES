...
table(des$variables$land_use_1)
table(des$variables$land_cover_1)
summary(des$variables$area)
...
write.xlsx(est_eu23_t, ".\\EU_estimates\\Europe_LC_LU_3digits.xlsx", sheetName = "Europe23_landuse", 
...
write.xlsx(est_eu27_t, ".\\EU_estimates\\Europe_LC_LU_3digits.xlsx", sheetName = "Europe27_landuse", 
           col.names = FALSE, row.names = FALSE, append = TRUE)
...
write.xlsx(est_eu28_t, ".\\EU_estimates\\Europe_LC_LU_3digits.xlsx", sheetName = "Europe28_landuse", 
           col.names = FALSE, row.names = FALSE, append = TRUE)
