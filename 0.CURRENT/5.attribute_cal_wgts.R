...
setwd("D:/Google Drive/LUCAS 2025/Task 1 - ESTIMATES/0.CURRENT/weights2022")
s_wgt <- NULL
...
summary(s_wgt$cal_wgt)
dim(s_wgt)
write.table(s_wgt,file=paste0(path_data,"Survey_2022_cal_wgt.txt"),sep="\t",row.names=F,col.names=T,quote=F)
