...
#######################################################################
library(xlsx)
# setwd("C:\\Users\\Giulio\\Google Drive\\LUCAS 2025\\2.TWO PHASES light\\1.STANDARD\\anomalies")
setwd("D:/Google Drive/LUCAS 2025/Task 1 - ESTIMATES/2.TWO PHASES light/anomalies")
