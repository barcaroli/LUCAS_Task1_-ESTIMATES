...
#---------------------------------------------------------------------------------
# To be launched in two steps for memory problems
# once for area and land cover (sheetname=EuropeXX)
# once for land use (sheetname=EuropeXX_landuse)
# Then manually cut and paste in the Excel file
#---------------------------------------------------------------------------------
...
europa22$land_cover_1 <- as.factor(substr(europa22$land_cover,1,3))
europa22$land_use_1 <- as.factor(substr(europa22$land_use,1,4))
...
write.xlsx(est_eu22_t, file=paste0(path_output,"Europe_LC_LU_3digit.xlsx"), 
           sheetName = "Europe22", 
...
europa26$land_cover_1 <- as.factor(substr(europa26$land_cover,1,3))
europa26$land_use_1 <- as.factor(substr(europa26$land_use,1,4))
...
write.xlsx(est_eu26_t, file=paste0(path_output,"Europe_LC_LU_3digit.xlsx"), 
           sheetName = "Europe26", 
...
write.xlsx(est_eu27_t, file=paste0(path_output,"Europe_LC_LU_3digit.xlsx"), 
           sheetName = "Europe27", 
           col.names = FALSE, row.names = FALSE, append = TRUE)
save.image(file=paste0(path_output,"Europe_3digit.RData"))