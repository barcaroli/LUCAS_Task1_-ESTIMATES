...
for(i in 1:length(countries)){
  ...
  est_2 <- est_2[,c("NUTS2","Variable","standard_Estimate","twophase_Estimate","area_rel_diff","standard_CV","twophase_CV","cv_diff")]
  ...
  t <- formattable(
    est_2[,c("NUTS2", "Variable","standard_Area_2022","twophase_Area_2022","area_rel_diff","standard_CV_2022","twophase_CV_2022","cv_diff")],
    list(
