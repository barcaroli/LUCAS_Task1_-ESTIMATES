...
dir_estimate_toadd="D:/Google Drive/LUCAS 2025/Task 1 - ESTIMATES/2.TWO PHASES/estimates2022proTwoPhasesField/"
...
ht <- aux.estimates(design=des2, calmodel = ~
                      SURVEY_LC1_1 +
                      SURVEY_LU1_1 - 1)
# ht[, names(ht) %in% names(des2)] <- popfill[, names(popfill) %in% names(ht)]
bounds.hint(des2,ht)
...
est_LC1_LU1_2nd$SE = est_LC1_LU1_2nd$SE.x+est_LC1_LU1_2nd$SE.y
...
est_LC1_LU1_NUTS1_24_2nd$SE = est_LC1_LU1_NUTS1_24_2nd$SE.x+est_LC1_LU1_NUTS1_24_2nd$SE.y
...
#new updated variables
est_LC1_LU1_NUTS2_24_2nd$SE = est_LC1_LU1_NUTS2_24_2nd$SE.x+est_LC1_LU1_NUTS2_24_2nd$SE.y
