...
europa23 <- rbind(s2009[!s2009$NUTS0_16 %in% c("BG","HR","CY","MT","RO","UK"),],
                  s2012[!s2012$NUTS0_16 %in% c("BG","HR","CY","MT","RO","UK"),],
                  s2015[!s2015$NUTS0_16 %in% c("BG","HR","CY","MT","RO","UK"),],
                  s2018[!s2018$NUTS0_16 %in% c("BG","HR","CY","MT","RO","UK"),])
...
write.xlsx(est_eu23_t, ".\\EU_estimates\\Europe_settl_FAO_LUE_LUD.xlsx", sheetName = "Europe23_noUK", 
...
europa27 <- rbind(s2012[s2012$NUTS0_16 != "HR" & s2012$NUTS0_16 != "UK",],
                  s2015[s2015$NUTS0_16 != "HR" & s2015$NUTS0_16 != "UK",],
                  s2018[s2018$NUTS0_16 != "HR" & s2018$NUTS0_16 != "UK",])
...
write.xlsx(est_eu27_t, ".\\EU_estimates\\Europe_settl_FAO_LUE_LUD.xlsx", sheetName = "Europe27_noUK", 
           col.names = FALSE, row.names = FALSE, append = TRUE)
...
# Europe 28 countries
#---------------------------------------------------
europa28 <- rbind(s2015[s2015$NUTS0_16 != "UK",],
                  s2018[s2018$NUTS0_16 != "UK",])
...
write.xlsx(est_eu28_t, ".\\EU_estimates\\Europe_settl_FAO_LUE_LUD.xlsx", sheetName = "Europe28_noUK", 
           col.names = FALSE, row.names = FALSE, append = TRUE)
