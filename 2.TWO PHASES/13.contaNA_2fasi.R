...
colnames(D)=c("Domain", 
  ...
  # LC 2 digit
  F= openxlsx::read.xlsx("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/A_Estimates_comparison.xlsx", sheet=1)
  #
  ...
  # LU 2 digits
  F= openxlsx::read.xlsx("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/A_Estimates_comparison.xlsx", sheet=2)
  #
  if(length(grep("x",F$Variable))>0){
    F <- F[-grep("x",F$Variable),]
  }
  ...
  # LC 3 digits
  F= openxlsx::read.xlsx("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/A_Estimates_comparison.xlsx", sheet=3)
  #
  if(length(grep("x",F$Variable))>0){
    F <- F[-grep("x",F$Variable),]
  }
  ...
  # LU 3 digits 
  F= openxlsx::read.xlsx("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/A_Estimates_comparison.xlsx", sheet=4)
  #
  if(length(grep("x",F$Variable))>0){
    F <- F[-grep("x",F$Variable),]
  }
...
for(i in 1:length(countries)){
  print(countries[i])
  # LC 2 digit
  F= openxlsx::read.xlsx(paste0("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/", countries[i],"_Estimates_comparison.xlsx"), sheet=1)
  #
  if(length(grep("x",F$Variable))>0){
    F <- F[-grep("x",F$Variable),]
  }
 ...
 # LU 2 digits
 F= openxlsx::read.xlsx(paste0("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/", countries[i],"_Estimates_comparison.xlsx"), sheet=2)
 #
 if(length(grep("x",F$Variable))>0){
   F <- F[-grep("x",F$Variable),]
 }
 ...
 # LC 3 digits
 F= openxlsx::read.xlsx(paste0("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/", countries[i],"_Estimates_comparison.xlsx"), sheet=3)
 #
 if(length(grep("x",F$Variable))>0){
   F <- F[-grep("x",F$Variable),]
 }
 ...
 # LU 3 digits 
 F= openxlsx::read.xlsx(paste0("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/", countries[i],"_Estimates_comparison.xlsx"), sheet=4)
 #
 if(length(grep("x",F$Variable))>0){
   F <- F[-grep("x",F$Variable),]
 }
...
print(countries[i])
# LC 2 digits
F= openxlsx::read.xlsx(paste0("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/", countries[i],"_NUTS1_Estimates_comparison.xlsx"), sheet=1)
#
if(length(grep("x",F$Variable))>0){
  F <- F[-grep("x",F$Variable),]
}
...
# LU 2 digits
F= openxlsx::read.xlsx(paste0("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/", countries[i],"_NUTS1_Estimates_comparison.xlsx"), sheet=2)
#
if(length(grep("x",F$Variable))>0){
  F <- F[-grep("x",F$Variable),]
}
...
# LC 3 digits
F= openxlsx::read.xlsx(paste0("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/", countries[i],"_NUTS1_Estimates_comparison.xlsx"), sheet=3)
#
if(length(grep("x",F$Variable))>0){
  F <- F[-grep("x",F$Variable),]
}
...
# LU 3 digits
F= openxlsx::read.xlsx(paste0("//pc.istat.it/xendesktop/DaaS/ilaria.bombelli/Desktop/GruppiDiLAvoro/Progetto_LUCAS/Task1/2.TWO PHASES/Estimates_comparison/", countries[i],"_NUTS1_Estimates_comparison.xlsx"), sheet=4)
#
if(length(grep("x",F$Variable))>0){
  F <- F[-grep("x",F$Variable),]
}
